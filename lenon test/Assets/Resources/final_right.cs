...
public class final_right : MonoBehaviour
{
    float x1, x2, y1, y2;
    ...
    */
    ...
    void checkPass()
    {
        Debug.Log("password: " + password[0].ToString() + password[1].ToString() + password[2].ToString() + password[3].ToString() + password[4].ToString());

        string savePath = @"C:\\Users\\minji\\Desktop\\unity_practice\\lenon test\\Assets\\Resources\\password.txt";
        string textValue = (password[0]).ToString() + password[1].ToString() + (password[2]).ToString() + password[3].ToString() + (password[4]).ToString();
    ...
    void makeEyeExcel()
    {
       ...
       // Debug.Log("right"+records.Length);
        if(portion==0)
        {
            ...
            {
                Debug.Log("r1");
                transform.localEulerAngles = new Vector3(eyeAxis[0, 3], eyeAxis[0, 4], eyeAxis[0, 5]);
            ...
            {
                Debug.Log("r2");
                transform.localEulerAngles = new Vector3(eyeAxis[1, 3], eyeAxis[1, 4], eyeAxis[1, 5]);
            ...
            {
                Debug.Log("r3");
                transform.localEulerAngles = new Vector3(eyeAxis[2, 3], eyeAxis[2, 4], eyeAxis[2, 5]);
            ...
            {
                Debug.Log("r4");
                transform.localEulerAngles = new Vector3(eyeAxis[3, 3], eyeAxis[3, 4], eyeAxis[3, 5]);
            ...
            else if (float.Parse(fields[0]) >= xpos1 && float.Parse(fields[0]) <= xpos2 && float.Parse(fields[1]) >= ypos1)//5+8번 영역(마지막 확인용)​
			{
				...
				{
                    Debug.Log("r5");
                    transform.localEulerAngles = new Vector3(eyeAxis[4, 3], eyeAxis[4, 4], eyeAxis[4, 5]);
                }
                if (float.Parse(fields[0]) >= xpos1 && float.Parse(fields[0]) <= xpos2 && float.Parse(fields[1]) > ypos2)//8번영역(동공 이동 확인용)​
				{
                    Debug.Log("r8");
                    transform.localEulerAngles = new Vector3(eyeAxis[7, 3], eyeAxis[7, 4], eyeAxis[7, 5]);
                }
			...
			{
                Debug.Log("r6");
                transform.localEulerAngles = new Vector3(eyeAxis[5, 3], eyeAxis[5, 4], eyeAxis[5, 5]);
			...
			{
                Debug.Log("r7");
                transform.localEulerAngles = new Vector3(eyeAxis[6, 3], eyeAxis[6, 4], eyeAxis[6, 5]);
			...
			{
                Debug.Log("r9");
                transform.localEulerAngles = new Vector3(eyeAxis[8, 3], eyeAxis[8, 4], eyeAxis[8, 5]);
